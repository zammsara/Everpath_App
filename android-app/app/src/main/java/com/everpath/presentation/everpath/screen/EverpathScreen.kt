...
fun EverpathScreen(
    ...
    val selectedGoal =
        uiState
            ...
            .goalNodes
            .find {
                it.id == uiState.value.selectedGoalId
            }
    ...
    Scaffold(
        floatingActionButton = {
            ...
            Column(
                ...
                if (
                    uiState.value.selectedConnectionId != null
                ) {
        ...
        Column {
            ...
            if (
                ...
                Text(
                    text = "Selecciona la meta destino para crear la conexión",
                    modifier =
                        Modifier.padding(
                            16.dp
                        )
            ...
            EverpathCanvas(
                goalNodes =
                    uiState.value.goalNodes,

                positions =
                    uiState.value.positions,

                connections =
                    uiState.value.connections,

                draggingPositions =
                    uiState.value.draggingPositions,
        ...
        if (
            ...
            CreateGoalDialog(
                ...
                onSave = { title, description, lifeArea ->
